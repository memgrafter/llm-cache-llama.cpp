...
export MODEL="${MODEL:-$MODELS_DIR/VibeThinker-3B-Q4_K_M.gguf}"
export ALIAS="${ALIAS:-local-model,VibeThinker-3B-Q4_K_M}"
export CACHE_DIR="${CACHE_DIR:-$HOME/.cache/llama.cpp-launch-scripts/vibethinker-3b-q4km-nonthinking}"
