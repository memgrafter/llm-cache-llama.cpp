...
export MODEL="${MODEL:-$MODELS_DIR/Qwen3.6-27B-UD-Q8_K_XL.gguf}"
export ALIAS="${ALIAS:-local-model,Qwen3.6-27B-MTP-UD-Q8_K_XL}"
export CACHE_DIR="${CACHE_DIR:-$HOME/.cache/llama.cpp-launch-scripts/qwen36-27b-ud-mtp-q8kxl}"
