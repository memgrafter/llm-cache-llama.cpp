...
export CACHE_REUSE="${CACHE_REUSE:-256}"
export SPEC_TYPE="${SPEC_TYPE:-ngram-mod}"
export SPEC_NGRAM_MOD_N_MATCH="${SPEC_NGRAM_MOD_N_MATCH:-24}"
export SPEC_NGRAM_MOD_N_MIN="${SPEC_NGRAM_MOD_N_MIN:-48}"
export SPEC_NGRAM_MOD_N_MAX="${SPEC_NGRAM_MOD_N_MAX:-63}"
export FLASH_ATTN="${FLASH_ATTN:-auto}"
export KV_OFFLOAD="${KV_OFFLOAD:-1}"
